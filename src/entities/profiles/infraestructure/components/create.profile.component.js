...
import { newProfile }                   from '../../core/actions/profile.actions';
...
const CreateProfile =()=>{
    ...
    const resetProfileState = ()=>{
        setProfileState({...profileState, "name":"", "email":""})
        setPermissionState(getEmptyPermission())
    }
    ...
    return (
        <div>
            ...
            <div className="flex">
                <SideMenu code="7" sub="24"></SideMenu>
                <div className="content">
                    <Header></Header>
                    <div className="intro-y flex flex-col sm:flex-row items-center mt-8">
                        <h2 className="text-lg font-medium mr-auto"> Nuevo perfil </h2> 
                        <div className="w-full sm:w-auto flex mt-4 sm:mt-0"> 

                            <button style={{display:(loading.button)?"":"none" }} className="button w-40 mt-5 text-white bg-theme-1 inline-flex items-center ml-auto"> Registrando <img className="h-5 ml-3" alt="" src="/assets/images/white.gif"></img></button>
                            <button style={{display:(loading.button)?"none":"" }} type="button" 
                                    onClick={()=>{ dispatch(newProfile({...profileState, 
                                                                        permission  : permissionState, 
                                                                        company     : cookie.cookie.login.companyId ,
                                                                        host        : cookie.cookie.login.name      ,
                                                                        companyName : cookie.cookie.company.CompanyName,
                                                                        resetProfileState: resetProfileState
                                                                    })) }}
                                    className="button w-40 bg-theme-1 text-white mt-5">Registrar perfil</button>
                        </div>                                                                      
                    </div>
                                ...
                                <div className="mt-5">
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <input type="email" id="email" name="email"
                                            ...
                                            className="input pl-12 w-full border col-span-4" placeholder="Correo electrónico" />
                                    </div>
                                </div>
