...
import { getTaxes } from '../../core/selector/taxes.selector';
import { DeleteTax } from '../../core/actions/taxes.actions';
...
const DeleteConfirmation =(props)=>{
    ...
    const onConfirmationDelete =()=>{        
        dispatch(DeleteTax(props.state))
    }

    return (
        <>
             <div>                
                    <div className="modal" id="delete-tax">
                        <div className="modal__content">
                            <div className="p-5 text-center"> <i data-feather="x-circle" className="w-16 h-16 text-theme-6 mx-auto mt-3" />                                
                                {taxes.taxReponse.show_response
                                    ...
                                    :<></> }                                  
                                <div className="text-gray-600 mt-2">¿Estás seguro que quieres eliminar este impuesto?</div>
                            </div>
                        <div className="px-5 pb-8 text-center"> 
                            ...
                            <>
                                ...
                                <button style={{display:(loading.buttonPopUp)?"none":"" }} onClick={onConfirmationDelete}  type="button" className="button w-40 border bg-theme-6 text-white mr-1">Eliminar </button> 
                            </>                            
                        </div>
                    </div>
                </div>
