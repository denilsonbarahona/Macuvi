...
import { gettingDailyProductsSales }  from '../../core/actions/report.actions';
...
const TodayProductsSales =()=>{
    ...
    useEffect(()=>{
        if(!cookie.find){
            ...
            dispatch(gettingDailyProductsSales({updateSetReportState:updateSetReportState, ...params, 
                                         company : cookie.cookie.login.companyId, 
                                         isMaster: cookie.cookie.login.isMaster ,
                                         uid     : cookie.cookie.login.id }))                             
        }
    },[cookie.find, dispatch, cookie.cookie.login.id, cookie.cookie.login.isMaster, cookie.cookie.login.companyId])
    ...
    return (
        <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
            <div className="report-box zoom-in">
                {loading.productsDailySales 
                    ?<div className="box pb-20 pt-9"><UiLoading loading={loading.productsDailySales}></UiLoading></div>
                    :<div className="box p-5">
                        ...
                        <div className="text-base text-gray-600 mt-1">Productos vendidos del día</div>
                     </div> }
...
export default TodayProductsSales;