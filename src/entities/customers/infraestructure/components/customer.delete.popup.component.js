...
import { DeleteCustomerById }       from '../../core/actions/customer.action';

const DeleteCustomerConfirmation =(props)=>{
    ...
    const onConfirmationDelete=()=>{
        dispatch(DeleteCustomerById({id      : props.state.idDelete, 
    ...
    return (
        <>
             <div>                
                    <div className="modal" id="delete-customer">
                        <div className="modal__content">
                            <div className="p-5 text-center"> <i data-feather="x-circle" className="w-16 h-16 text-theme-6 mx-auto mt-3" />
                                ...
                                <div className="text-gray-600 mt-2">¿Está seguro que quiere eliminar la información de este cliente?</div>
                            </div>
