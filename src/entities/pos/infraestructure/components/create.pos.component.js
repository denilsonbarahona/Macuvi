...
import { setNewPOS  }                   from '../../core/actions/posActions';
...
const CreatePOS =()=>{
    ...
    const [posState, setPosState] = useState({name: "" , percentage:"", 
                                              ...
                                              greater : [
                                                {key1: "percentage", greatherThan:-1, errordescription:"El porcentaje tiene que ser mayor o igual a cero."},                                                
                                              ] })
    ...
    const onNewPOSClick =()=>{
        dispatch(setNewPOS({ ...posState, company: cookie.cookie.login.companyId , onSetPOSState: onSetPOSState }))
    }

    const onSetPOSState =()=>{

        setPosState({   name    : "" , percentage:"", 
                        required:["name","percentage"],
    ...
    return (
        <>
            ...
            <div className="flex">
                <SideMenu code="7" sub="26"></SideMenu>
                <div className="content">
                    <Header></Header>
                    <div className="intro-y flex flex-col sm:flex-row items-center mt-8">
                        <h2 className="text-lg font-medium mr-auto"> Nuevo POS </h2>     
