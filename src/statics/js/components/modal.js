...
window.addEventListener("load",()=>{
      ...
      const show =(el) =>{ 
            ...
            if(window.onOpenStatePopUp !== undefined){
                window.onOpenStatePopUp()
            }
      ...
      const hide = (el) => {
          if (cash(el).hasClass("modal") && cash(el).hasClass("show")) {
                ...
                if(window.onClosePopUp !== undefined){
                    window.onClosePopUp() 
                    window.onClosePopUpChange()
                }
      ...
      // Show modal
      cash("body").on("click", 'div[data-toggle="modal"]', function () {          
