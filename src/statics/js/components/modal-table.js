...
window.addEventListener("load",()=>{
      ...
      function getHighestZindex() {
          let zIndex = 52;
          cash(".modal__product").each(function () {
              if (
      ...
      const show =(el) =>{ 
            ...
            cash(el)
                ...
                .addClass(cash(".modal__product.show").length ? "modal__overlap" : "");
      ...
      const hide = (el) => {
          if (cash(el).hasClass("modal__product") && cash(el).hasClass("show")) {
      ...
      // Show modal
      cash("body").on("click", 'div[data-toggle="modal__product"]', function () {          
      ...
      cash("body").on("click", '[data-dismiss="modal__product"]', function () {
          let modal = cash(this).closest(".modal__product")[0];
          hide(modal);
      });
