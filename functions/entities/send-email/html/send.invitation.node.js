exports.invitation = function(params) {
  const html =
    `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml"
    style="font-family: 'Helvetica Neue',
    Helvetica, Arial, sans-serif; box-sizing:
    ...
    <style type="text/css">
    img { max-width: 100%; }
    body { -webkit-font-smoothing: antialiased; -webkit-text-size-adjust:
    none; width: 100% !important; height: 100%; line-height: 1.6em; }
    ...
    background-color: #f6f6f6; margin: 0;" bgcolor="#f6f6f6">
    <table class="body-wrap"
    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box;
    font-size: 14px; width: 100%; background-color: #f6f6f6;
    margin: 0;" bgcolor="#f6f6f6" >
    ...
    <div class="content" 
    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box; font-size: 14px; max-width: 600px; 
    ...
    background-color: #fff; margin: 0; border: 1px solid #e9e9e9;"
    bgcolor="#fff">
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box; font-size: 14px;
    margin: 0;">
    ...
    valign="top">
    <h2 style="color:#205081;">Bienvenido a Macuvi!.</h2>
    <hr style="background-color: #e9e9e9;"  size="1" >
    </td>
    </tr>
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box; font-size: 14px; margin: 0;">
    ...
    vertical-align: top; margin: 0; padding: 0 0 20px;"
    valign="top">
    Hola ${params.PreLoginName}.
    <br>
    ${params.PreLoginHostName} te ha invitado a
    registrarte en MACUVI para que
    formes parte de su equipo de trabajo.
    Has click en el botón para crear tu
    usuario en MACUVI.
    </td>
    </tr>
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    ...
    <a href="http://macuvi.io/invitation/`+
    `${params.PreLoginEmail}/`+
    `${params.PreloginReference}/${params.PreLoginName}"
    ...
    margin: 0; border-color: #348eda; border-style: solid;
    border-width: 10px 20px;">¡¡Regístrate aquí!!</a>
    </td>
    </tr>
    <tr>
    <td>
    Si tu no eres ${params.PreLoginName} por favor omite este correo.
    </td>
    </tr>
    </table>
    </td>
    ...
    <div class="footer"
    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box; font-size: 14px; width: 100%;
    clear: both; color: #999; margin: 0; padding: 20px;">
    <table width="100%"
    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    box-sizing: border-box; font-size: 14px; margin: 0;">
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
    ...
    align="center" valign="top">© Macuvi 2020.
    Tegucigalpa. Francisco Morazán</td>
    </tr>
    </table>
    </div>
    </div>
